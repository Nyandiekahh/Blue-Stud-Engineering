        ...
        <div className="p-6 space-y-8">
          ...
          <section>
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-700">6. Switchyard Direct Strike Lightning Protection (DSLP) calculation and specifications</p>
              <p className="text-gray-700">7. Lighting calculation - switchyard and control building</p>
              <p className="text-gray-700">8. 110V DC battery and charger sizing calculation and specifications - Total 110DC load</p>
              <p className="text-gray-700">9. 48V DC battery and charger sizing calculation and specifications - Total 48DC Load</p>
              ...
              <p className="text-gray-700">11. Transformer sizing and specifications</p>
              <p className="text-gray-700">12. Air conditioner sizing calculation - Substation specification</p>
            </div>
          </section>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                ...
                Click to read more about Design and Engineering
            ...
            <div className="lg:order-2">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <span className="text-gray-700">Transformer oil Dissolved Gas Analysis (DGA)</span>
                </div>
                <div className="flex items-start space-x-3">
                  <svg className="w-6 h-6 text-blue-900 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span className="text-gray-700">Transformer oil filtration</span>
                </div>
              </div>
            </div>
            ...
            <div className="lg:order-2">
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <div className="space-y-2 text-sm">
                  <p className="text-gray-700">• Oil filtration machine</p>
                  <p className="text-gray-700">• OMICRON CMC 356 universal relay test set</p>
                  <p className="text-gray-700">• Sverker 750 relay test unit</p>
                  ...
                  <p className="text-gray-700">• Frida Very Low Frequency (VLF) insulation Test set</p>
                  ...
                  <p className="text-gray-700">• MEGGER BDV Oil Test Set OTS80PB</p>
